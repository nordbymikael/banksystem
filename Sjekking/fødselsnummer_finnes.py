...
def fødselsnummer_sjekk_om_finnes (fødslesnummer):
    mysqlconnector.mycursor.execute(f"SELECT FØDSELSNUMMER FROM KUNDEINFO WHERE FØDSELSNUMMER = \"{fødslesnummer}\"") # jeg henter fødselsnummeret som jeg definerte i parameter og kjører en spørring som sjekker om fødselsnummeret er definert i KUNDEINFO tabellen
