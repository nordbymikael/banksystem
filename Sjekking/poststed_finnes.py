def poststed_sjekk_om_finnes (postnummer):
    mycursor.execute(f"SELECT POSTSTED FROM POSTSTED WHERE POSTNUMMER = \"{postnummer}\"") # jeg henter postnummeret som jeg definerte i parameter og kjører en spørring som sjekker om postnummeret er definert i POSTSTED tabellen
